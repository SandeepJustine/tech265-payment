...
$groups = [
  'System' => [
    ...
    [
      'method'=>'GET', 'path'=>'/v1/status', 'auth'=>'none',
    ...
    [
      'method'=>'GET', 'path'=>'/v1/info', 'auth'=>'none',
  ...
  'Payments' => [
    [
      'method'=>'POST', 'path'=>'/v1/payments/initiate', 'auth'=>'full',
    ...
    [
      'method'=>'GET', 'path'=>'/v1/payments', 'auth'=>'key',
    ...
    [
      'method'=>'GET', 'path'=>'/v1/payments/{tx_ref}', 'auth'=>'key',
    ...
    [
      'method'=>'GET', 'path'=>'/v1/payments/verify/{tx_ref}', 'auth'=>'key',
    ...
    [
      'method'=>'POST', 'path'=>'/v1/payments/callback', 'auth'=>'webhook',
    ...
    [
      'method'=>'GET', 'path'=>'/v1/payments/return', 'auth'=>'webhook',
  ...
  'Logs' => [
    [
      'method'=>'GET', 'path'=>'/v1/logs/api', 'auth'=>'key',
    ...
    [
      'method'=>'GET', 'path'=>'/v1/logs/errors', 'auth'=>'key',
    ...
    [
      'method'=>'GET', 'path'=>'/v1/logs/webhooks', 'auth'=>'key',
  ...
  'Statistics' => [
    [
      'method'=>'GET', 'path'=>'/v1/stats', 'auth'=>'key',
