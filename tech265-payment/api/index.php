...
function route_info($params, $keyMeta)
{
    ApiMiddleware::json([
        ...
        'endpoints'   => [
            ['method' => 'GET',  'path' => '/v1/health',                   'auth' => false,      'description' => 'Full health check (DB, PayChangu API, PHP extensions, disk)'],
            ['method' => 'GET',  'path' => '/v1/status',                   'auth' => false,      'description' => 'Lightweight ping / version info'],
            ['method' => 'GET',  'path' => '/v1/info',                     'auth' => false,      'description' => 'API documentation and route listing'],
            ['method' => 'POST', 'path' => '/v1/payments/initiate',        'auth' => 'full',     'description' => 'Initiate a new payment session, returns checkout_url'],
            ['method' => 'GET',  'path' => '/v1/payments',                 'auth' => 'readonly', 'description' => 'List transactions with filtering and pagination'],
            ['method' => 'GET',  'path' => '/v1/payments/{tx_ref}',        'auth' => 'readonly', 'description' => 'Get a single transaction by tx_ref'],
            ['method' => 'GET',  'path' => '/v1/payments/verify/{tx_ref}', 'auth' => 'readonly', 'description' => 'Verify a transaction directly with PayChangu'],
            ['method' => 'POST', 'path' => '/v1/payments/callback',        'auth' => 'webhook',  'description' => 'PayChangu IPN callback handler (set as callback_url)'],
            ['method' => 'GET',  'path' => '/v1/payments/callback',        'auth' => 'webhook',  'description' => 'PayChangu redirect callback handler'],
            ['method' => 'GET',  'path' => '/v1/payments/return',          'auth' => 'webhook',  'description' => 'PayChangu return URL for failed or cancelled payments'],
            ['method' => 'GET',  'path' => '/v1/logs/api',                 'auth' => 'readonly', 'description' => 'List API activity logs'],
            ['method' => 'GET',  'path' => '/v1/logs/errors',              'auth' => 'readonly', 'description' => 'List error logs'],
            ['method' => 'GET',  'path' => '/v1/logs/webhooks',            'auth' => 'readonly', 'description' => 'List webhook logs'],
            ['method' => 'GET',  'path' => '/v1/stats',                    'auth' => 'readonly', 'description' => 'Payment statistics and daily summary'],
        ],
    ]);
}
